    ...
    <main className="page-shell">
      <div className="container landing-stack">
        <section className="hero-grid">
          ...
          <div className="hero-visual panel hero-blue">
        ...
        <section className="three-col-grid">
          <article className="panel feature-card">
            ...
            <p className="muted copy">
              ...
              qualifications, and job-fit signals instead of a vague black-box
              score.
            </p>
          </article>
          ...
          <article className="panel feature-card">
            ...
            <p className="muted copy">
              ...
              employers can post jobs, shortlist talent, and review ranked
              matches.
            </p>
          </article>
        </section>
        ...
        <section className="panel section-block">
          ...
          <div className="four-step-grid">
            <article className="step-card">
              ...
              <p className="muted copy">
                Applicants upload resumes while employers submit job
            ...
            <article className="step-card">
              ...
              <p className="muted copy">
                The system compares skills, experience, education, and required
                competencies before ranking.
              </p>
            </article>
            ...
            <article className="step-card">
              ...
              <p className="muted copy">
                Promising matches are sorted so both sides can focus on the
        ...
        <section className="panel section-block">
          ...
          <div className="three-col-grid">
            <article className="feature-card">
              ...
              <p className="muted copy">
                Applicants can stop guessing why a role feels out of reach and
                instead see what strengths helped and which gaps reduced the
                match.
              </p>
            </article>
            ...
            <article className="feature-card">
              <h2>For employers</h2>
              <p className="muted copy">
                Recruiters can review talent with more structure, focusing first
                on candidates who satisfy core requirements and show strong fit.
              </p>
            </article>
